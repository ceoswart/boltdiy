/*
  ...
  1. Tables
    ...
    - action_paths: Sales action paths with deal size categorization
    - action_path_territories: Junction table for territory mappings
    - action_path_products: Junction table for product mappings
    - actions: Sales actions with assignments and categorization
