/*
  ...
  3. Security
    ...
    - Add policies for authenticated users to:
      - View assignees within their email domain
      - Manage assignees within their email domain
*/
...
-- Create policies based on email domain matching
CREATE POLICY "Users can view assignees in their domain"
  ON assignees
  FOR SELECT
  TO authenticated
  USING (
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE tgname = 'update_assignees_updated_at'
  ) THEN
