/*
  # Fix Schema Setup for SalesV2 Kanban

  This migration fixes the schema setup by:
  1. Ensuring proper table creation
  2. Setting up correct RLS policies
  3. Configuring triggers and functions
  4. Setting up the admin user profile handling
*/

-- First, let's clean up any existing objects to ensure a clean slate
DO $$ 
BEGIN
...
-- Create trigger for action_paths
